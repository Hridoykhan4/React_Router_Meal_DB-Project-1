...
import { addToLocalStorage } from "../utils/addBlogMark";
...
const Blog = () => {
  ...
  const handleBlogAdd = blog => {
    addToLocalStorage(blog)
  }
      ...
      <article className="space-y-8 ">
        <div className="space-y-6">
          ...
          <div className="flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap ">
            ...
            <button onClick={() => handleBlogAdd(blog)} className="btn">BookMark</button>
          </div>
        </div>
